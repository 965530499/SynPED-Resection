...
from .image_encoder_adapter import ImageEncoderViTAdapter
from .mask_decoder_adapter import MaskDecoderAdapter
from .prompt_encoder_adapter import PromptEncoderAdapter
...
class SAM(nn.Module): # With Adapter, from SAM-Adapter-PyTorch/models/sam.py
    def __init__(self, inp_size=None, encoder_mode=None, loss=None):
        ...
        self.mask_decoder = MaskDecoderAdapter(
